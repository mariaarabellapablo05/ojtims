...
<body>
    ...
    <!-- Content Section -->
    <div class="content">
        <h2 style="color: black; font-size: 28px;">Congratulations! Your account had been created.</h2>
        <p style="font-size: 18px;">Your temporary password is: <strong>{{$temporaryPassword}}</strong></p>

        <!-- Centered Button -->
        <div style="text-align: center;"> <!-- Add this container -->
        <!-- Add a customizable rectangular button with a link -->
        <a class="button" href="{{url('/login')}}" style="color:white">Login now</a>
    </div>
    </div>
